...
async fn handle_discover(
    ...
    html_body
        .push_str(" class=\"min-h-screen bg-brand-navy font-sans overflow-hidden flex flex-col\"");
    html_body.push('>');
    ...
    html_body.push_str(" stroke-width=\"2\"");
    html_body
        .push_str(" d=\"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z\"");
    html_body.push('>');
    html_body.push_str("</path>");
    html_body.push_str("</svg>");
    html_body.push_str("</a>");
    ...
    html_body.push_str(
        " class=\"flex-1 flex items-center justify-center relative w-full max-w-md mx-auto p-4\"",
    );
    html_body.push('>');
    ...
    html_body.push_str("<div");
    html_body
        .push_str(" class=\"absolute inset-0 flex items-center justify-center text-gray-500 z-0\"");
    html_body.push('>');
    html_body.push_str("<div");
...
async fn handle_chat(
    ...
    html_body.push_str("<div");
    html_body.push_str(
        " class=\"h-16 flex items-center justify-between px-6 border-b border-white/10\"",
    );
    html_body.push('>');
    ...
    html_body.push_str("<main");
    html_body.push_str(
        " class=\"flex-1 flex flex-col relative bg-gradient-to-br from-brand-navy to-black\"",
    );
    html_body.push('>');
    html_body.push_str("<!-- Header -->");
    html_body.push_str("<header");
    html_body.push_str(
        " class=\"h-16 border-b border-white/10 flex items-center justify-between px-6 glass\"",
    );
    html_body.push('>');
    html_body.push_str("<div");
    ...
    html_body.push_str("<div");
    html_body.push_str(
        " class=\"bg-white/10 text-white px-4 py-2 rounded-2xl rounded-bl-none max-w-md\"",
    );
    html_body.push('>');
    ...
    html_body.push_str("<div");
    html_body.push_str(
        " class=\"bg-brand-rose text-white px-4 py-2 rounded-2xl rounded-br-none max-w-md\"",
    );
    html_body.push('>');
    html_body.push_str(
        "The one on 4th street? I was actually planning to go there today!\n                    ",
    );
    html_body.push_str("</div>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
...
async fn handle_index(
    ...
    html_body.push_str("<div");
    html_body.push_str(
        " class=\"w-8 h-8 rounded-full bg-gradient-to-tr from-brand-rose to-brand-gold\"",
    );
    html_body.push('>');
    html_body.push_str("</div>");
    html_body.push_str("<span");
    ...
    html_body.push_str("<span");
    html_body.push_str(
        " class=\"text-transparent bg-clip-text bg-gradient-to-r from-brand-rose to-brand-gold\"",
    );
    html_body.push('>');
    ...
    html_body.push_str("<p");
    html_body
        .push_str(" class=\"text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed\"");
    html_body.push('>');
