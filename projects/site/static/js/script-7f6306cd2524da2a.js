    ...
    <mj-section padding="16px 0 48px">
      <mj-column>
        ...
        function confirmBroadcast() {
            ...
            return confirm('⚠️ WARNING: This will send emails to ALL subscribers immediately.\n\nAre you sure you want to proceed?');
        }
        ...
        function sendTestEmail() {
            ...
            const email = prompt('Enter your email address to receive a test:');
            if (!email) return;
            
            showToast('Test email feature coming soon! Template ID: ' + templateId, 'info');
        }
