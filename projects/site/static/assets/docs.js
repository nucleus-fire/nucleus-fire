...
const categories = {
    ...
    'Guides': [
        ...
        '30_websocket_guide',
        '38_websocket_rooms_guide',
        '32_middleware_guide',
        '33_error_handling_guide',
        '34_job_queue_guide',
        '35_scheduled_jobs_guide',
        '36_session_guide',
        '37_redis_cache_guide',
        '44_cache_guide',
        '39_health_check_guide',
        '25_federation_guide',
        '25_email_guide',
