...
async fn handle_index(
    ...
    html_body.push_str(" href=\"data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='.9em' font-size='90'>⚡</text></svg>\"");
    html_body.push_str(">");
    html_body.push_str("</link>");
    ...
    html_body.push_str(
        " style=\"border-color: rgba(168, 85, 247, 0.3); background: rgba(168, 85, 247, 0.1);\"",
    );
    html_body.push_str(">");
    html_body.push_str("<span");
    ...
    html_body.push_str(">");
    html_body.push_str("🚀 10k+ Downloads");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"trusted-logo\"");
    html_body.push_str(">");
    html_body.push_str("⭐ 2.4k GitHub Stars");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"trusted-logo\"");
    html_body.push_str(">");
    html_body.push_str("👥 Growing Community");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"trusted-logo\"");
    html_body.push_str(">");
    html_body.push_str("🔒 Production Ready");
    html_body.push_str("</span>");
    html_body.push_str("</div>");
    html_body.push_str("</div>");
    html_body.push_str("</section>");
    ...
    html_body.push_str(">");
    html_body.push_str("Clean, expressive code that compiles to blazingly fast binaries.");
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(" data-tab=\"page\"");
    html_body.push_str(">");
    html_body.push_str("Full Page");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"tab-btn\"");
    html_body.push_str(" data-tab=\"form\"");
    html_body.push_str(">");
    html_body.push_str("Forms");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"tab-btn\"");
    html_body.push_str(" data-tab=\"island\"");
    html_body.push_str(">");
    html_body.push_str("Interactive");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"tab-btn\"");
    html_body.push_str(" data-tab=\"api\"");
    html_body.push_str(">");
    html_body.push_str("API Route");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"tab-btn\"");
    html_body.push_str(" data-tab=\"rpc\"");
    html_body.push_str(">");
    html_body.push_str("Server RPC");
    html_body.push_str("</button>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(" id=\"tab-page\"");
    html_body.push_str(">");
    ...
    html_body.push_str(">");
    html_body.push_str("&lt;!-- blog/[slug].ncl --&gt;");
    html_body.push_str("</span>");
    html_body.push_str("&#10;");
    html_body.push_str("<span");
    html_body.push_str(" class=\"tag\"");
    html_body.push_str(">");
    ...
    html_body.push_str("</span>");
    html_body.push_str("post = Post::find(slug).");
    html_body.push_str("<span");
    html_body.push_str(" class=\"keyword\"");
    html_body.push_str(">");
    ...
    html_body.push_str("</span>");
    html_body.push_str("{");
    html_body.push_str("post.content}");
    html_body.push_str("<span");
    html_body.push_str(" class=\"tag\"");
    html_body.push_str(">");
    html_body.push_str("&lt;/p&gt;");
    ...
    html_body.push_str(" id=\"tab-form\"");
    html_body.push_str(">");
    html_body.push_str("<pre");
    html_body.push_str(" class=\"code-block\"");
    html_body.push_str(">");
    ...
    html_body.push_str(" class=\"comment\"");
    html_body.push_str(">");
    html_body.push_str("&lt;!-- contact.ncl --&gt;");
    html_body.push_str("</span>");
    html_body.push_str("&#10;");
    html_body.push_str("<span");
    html_body.push_str(" class=\"tag\"");
    ...
    html_body.push_str("let");
    html_body.push_str("</span>");
    html_body.push_str("data = form.validate()?;&#10;    Postman::send(&amp;data.email).");
    html_body.push_str("<span");
    html_body.push_str(" class=\"keyword\"");
    html_body.push_str(">");
    html_body.push_str("await");
    ...
    html_body.push_str("<div");
    html_body.push_str(" class=\"tab-panel\"");
    html_body.push_str(" id=\"tab-island\"");
    html_body.push_str(">");
    html_body.push_str("<pre");
    html_body.push_str(" class=\"code-block\"");
    html_body.push_str(">");
    ...
    html_body.push_str(" class=\"comment\"");
    html_body.push_str(">");
    html_body.push_str("&lt;!-- Interactive island --&gt;");
    html_body.push_str("</span>");
    html_body.push_str("&#10;");
    html_body.push_str("<span");
    html_body.push_str(" class=\"tag\"");
    html_body.push_str(">");
    html_body.push_str("&lt;n:island");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"attr\"");
    html_body.push_str(">");
    html_body.push_str("client:visible");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"tag\"");
    html_body.push_str(">");
    ...
    html_body.push_str("let");
    html_body.push_str("</span>");
    html_body.push_str("count = Signal::new(");
    html_body.push_str("<span");
    ...
    html_body.push_str(">");
    html_body.push_str("{");
    html_body.push_str("count.set(c+1)}");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"tag\"");
    html_body.push_str(">");
    ...
    html_body.push_str(" class=\"comment\"");
    html_body.push_str(">");
    html_body.push_str("&lt;!-- api/users.ncl --&gt;");
    html_body.push_str("</span>");
    html_body.push_str("&#10;");
    html_body.push_str("<span");
    html_body.push_str(" class=\"tag\"");
    ...
    html_body.push_str(" class=\"attr\"");
    html_body.push_str(">");
    html_body.push_str("content_type");
    html_body.push_str("</span>");
    html_body.push_str("=");
    html_body.push_str("<span");
    html_body.push_str(" class=\"string\"");
    html_body.push_str(">");
    html_body.push_str("\"json\"");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"tag\"");
    html_body.push_str(">");
    ...
    html_body.push_str("let");
    html_body.push_str("</span>");
    html_body.push_str("users = User::query()&#10;      .filter(");
    html_body.push_str("<span");
    html_body.push_str(" class=\"string\"");
    html_body.push_str(">");
    ...
    html_body.push_str(" class=\"comment\"");
    html_body.push_str(">");
    html_body.push_str("// services/user.rs");
    html_body.push_str("</span>");
    html_body.push_str("&#10;");
    html_body.push_str("<span");
    html_body.push_str(" class=\"keyword\"");
    ...
    html_body.push_str("</span>");
    html_body.push_str("nucleus_std::server;&#10;&#10;");
    html_body.push_str("<span");
    html_body.push_str(" class=\"attr\"");
    html_body.push_str(">");
    ...
    html_body.push_str(" class=\"keyword\"");
    html_body.push_str(">");
    html_body.push_str("pub async fn");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"function\"");
    html_body.push_str(">");
    html_body.push_str("create_user");
    html_body.push_str("</span>");
    html_body.push_str("(&#10;  name: String&#10;) -&gt; Result&lt;User&gt; ");
    html_body.push_str("{");
    html_body.push_str("&#10;  User::create()&#10;    .set(");
    ...
    html_body.push_str(">");
    html_body.push_str(
        "Fine-grained reactivity with signals. Shared state across server and client boundaries.",
    );
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(">");
    html_body.push_str(
        "Powered by Tokio and Hyper. No garbage collection. Consistent sub-millisecond latency.",
    );
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(">");
    html_body.push_str(
        "Change your database schema. Get compile errors in your frontend. Ship with confidence.",
    );
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(">");
    html_body
        .push_str("State-preserving HMR that updates in milliseconds. Your flow, uninterrupted.");
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"feature-card\"");
    ...
    html_body.push_str(">");
    html_body.push_str(
        "CSP headers, HSTS, and XSS protection enabled by default. Fortress middleware built-in.",
    );
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(">");
    html_body.push_str(
        "WebSocket engine with automatic reconnection. Build live dashboards in minutes.",
    );
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(">");
    html_body
        .push_str("RFC 7231 compliant headers, automatic sitemaps, and optimized asset delivery.");
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"feature-card\"");
    ...
    html_body.push_str(">");
    html_body.push_str(
        "One-command SSG with incremental builds, WebP conversion, and multi-platform publish.",
    );
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(">");
    html_body.push_str(
        "Unified publish to Netlify, Vercel, Cloudflare, and GitHub Pages. No config needed.",
    );
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(">");
    html_body.push_str(
        "Interactive async REPL. Query your database, test functions, and debug logic instantly.",
    );
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(">");
    html_body
        .push_str("Built-in GUI for browsing tables, viewing schema, and executing SQL queries.");
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"feature-card\"");
    ...
    html_body.push_str(">");
    html_body.push_str(
        "First-class support for MCP and Agents. Build autonomous systems out of the box.",
    );
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("</div>");
    ...
    html_body.push_str(" class=\"section-title\"");
    html_body.push_str(">");
    html_body.push_str("42 modules. Zero dependencies.");
    html_body.push_str("</h2>");
    html_body.push_str("<p");
    html_body.push_str(" class=\"section-desc\"");
    html_body.push_str(">");
    ...
    html_body.push_str(">");
    html_body.push_str("<a href=\"/docs#18_complete_reference\" data-nucleus-link=\"true\">");
    html_body.push_str("View All 42 Modules →");
    html_body.push_str("</a>");
    html_body.push_str("</div>");
    html_body.push_str("</div>");
    html_body.push_str("</section>");
    ...
    html_body.push_str("<div");
    html_body
        .push_str(" style=\"display: flex; flex-direction: column; gap: 12px; font-size: 14px;\"");
    html_body.push_str(">");
    html_body.push_str("<div");
    ...
    html_body.push_str("<section");
    html_body.push_str(" id=\"comparison\"");
    html_body.push_str(" class=\"comparison-section\"");
    html_body.push_str(">");
    html_body.push_str("<div");
    html_body.push_str(" class=\"container\"");
    html_body.push_str(">");
    ...
    html_body.push_str("</h2>");
    html_body.push_str("</div>");
    html_body.push_str("<!-- Hero Stats Row -->");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-hero\"");
    html_body.push_str(">");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-hero-stat\"");
    html_body.push_str(">");
    html_body.push_str("<span");
    html_body.push_str(" class=\"compare-hero-value\"");
    html_body.push_str(">");
    html_body.push_str("20,400");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"compare-hero-unit\"");
    html_body.push_str(">");
    html_body.push_str("req/s");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"compare-hero-label\"");
    html_body.push_str(">");
    ...
    html_body.push_str(" class=\"compare-hero-value\"");
    html_body.push_str(">");
    html_body.push_str("42");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"compare-hero-unit\"");
    html_body.push_str(">");
    html_body.push_str("modules");
    html_body.push_str("</span>");
    html_body.push_str("<span");
    html_body.push_str(" class=\"compare-hero-label\"");
    html_body.push_str(">");
    html_body.push_str("Built-in");
    html_body.push_str("</span>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-hero-stat\"");
    ...
    html_body.push_str(" class=\"compare-hero-label\"");
    html_body.push_str(">");
    html_body.push_str("External Deps");
    html_body.push_str("</span>");
    html_body.push_str("</div>");
    html_body.push_str("</div>");
    html_body.push_str("<!-- Feature Comparison Table -->");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-table\"");
    html_body.push_str(">");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-row header\"");
    html_body.push_str(">");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cell feature\"");
    html_body.push_str(">");
    html_body.push_str("Feature");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cell nucleus\"");
    html_body.push_str(">");
    html_body.push_str("Nucleus");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cell other\"");
    html_body.push_str(">");
    html_body.push_str("Next.js");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-row\"");
    html_body.push_str(">");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cell feature\"");
    html_body.push_str(">");
    ...
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cell nucleus yes\"");
    html_body.push_str(">");
    html_body.push_str("✓");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cell other partial\"");
    html_body.push_str(">");
    html_body.push_str("~");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cell other no\"");
    html_body.push_str(">");
    html_body.push_str("✗");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cell other yes\"");
    html_body.push_str(">");
    html_body.push_str("✓");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str(" class=\"compare-cell feature\"");
    html_body.push_str(">");
    html_body.push_str("Auth System");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cell nucleus yes\"");
    html_body.push_str(">");
    ...
    html_body.push_str("</div>");
    html_body.push_str("<p");
    html_body.push_str(" class=\"compare-legend\"");
    html_body.push_str(">");
    html_body.push_str(
        "✓ Built-in &nbsp;&bull;&nbsp; ~ Plugin required &nbsp;&bull;&nbsp; ✗ Not available",
    );
    html_body.push_str("</p>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"compare-cta\"");
    html_body.push_str(">");
    html_body.push_str("<a");
    html_body.push_str(" href=\"/docs#18_complete_reference\"");
    html_body.push_str(" class=\"btn btn-secondary\"");
    html_body.push_str(">");
    html_body.push_str("Explore All 42 Modules →");
    html_body.push_str("</a>");
    html_body.push_str("</div>");
    html_body.push_str("</div>");
    html_body.push_str("</section>");
    ...
    /* Trusted By - Subtle dark with top border glow */
    .trusted-by {
        background: linear-gradient(180deg, #0a0a0a 0%, #080808 100%);
        border-top: 1px solid rgba(0, 220, 130, 0.1);
    }
    
    /* Examples - Deep purple-tinted dark */
    .examples {
        background: linear-gradient(180deg, #0d0a12 0%, #08060d 100%);
        position: relative;
    }
    .examples::before {
        content: '';
    ...
    /* Features - Rich dark with subtle blue tint */
    .features {
        background: linear-gradient(180deg, #070a0f 0%, #050810 100%);
        position: relative;
    }
    .features::before {
        content: '';
    ...
    /* Stdlib - Green accent glow */
    .stdlib-section {
        background: linear-gradient(180deg, #050d08 0%, #030805 100%) !important;
        position: relative;
    }
    .stdlib-section::before {
        background: linear-gradient(90deg, transparent, rgba(0, 220, 130, 0.4), transparent) !important;
    }
    
    /* Render Race Section - Deep contrast */
    .render-section {
    ...
    /* Benchmarks - Warm dark */
    .benchmarks {
        background: linear-gradient(180deg, #0c0908 0%, #080605 100%) !important;
        position: relative;
    }
    .benchmarks::before {
        content: '';
    ...
    /* Comparison - Neutral dark */
    .comparison {
        background: linear-gradient(180deg, #0a0a0a 0%, #060606 100%) !important;
    }
    
    /* Newsletter - Accent glow at bottom */
    .newsletter {
        background: linear-gradient(180deg, #080a0c 0%, #050608 100%);
        position: relative;
    }
    .newsletter::after {
        content: '';
        ...
        width: 400px;
        height: 200px;
        background: radial-gradient(ellipse, rgba(0, 220, 130, 0.08) 0%, transparent 70%);
        pointer-events: none;
    }
    
    /* CTA - Gradient glow */
    .cta {
        background: linear-gradient(180deg, #060608 0%, #0a0c10 100%);
        position: relative;
    }
    .cta::before {
        content: '';
        ...
        width: 600px;
        height: 400px;
        background: radial-gradient(ellipse, rgba(0, 220, 130, 0.1) 0%, rgba(14, 165, 233, 0.05) 50%, transparent 70%);
        pointer-events: none;
    }
    ...
    .compare-row.header .compare-cell.nucleus {
        color: var(--accent);
    }
    ...
    .compare-cell.nucleus {
        background: rgba(0, 220, 130, 0.05);
        font-weight: 600;
    }
    
    .compare-cell.nucleus.yes {
        color: var(--accent);
    }
    ...
    .compare-cell.other.yes {
        color: var(--accent);
    }
    
    .compare-cell.other.partial {
        color: #f59e0b;
    }
    
    .compare-cell.other.no {
        color: #6b7280;
    }
...
async fn handle_action_index(
    ...
    if !email.is_empty() && email.contains('@') {
        ...
        match query("subscribers")
            ...
            .await
        {
            Ok(_) => println!("✅ New Subscriber: {}", email),
            Err(e) => {
                // Handle duplicate (UNIQUE constraint) gracefully
                if e.to_string().contains("UNIQUE") {
                    println!("ℹ️  Subscriber already exists: {}", email);
                } else {
...
async fn handle_admin(
    ...
    for model in [crate::controllers::newsletter::fetch_admin_data().await] {
        ...
        html_body.push_str("<div");
        html_body
            .push_str(" style=\"font-weight: 700; font-size: 1.2rem; letter-spacing: -0.5px;\"");
        html_body.push_str(">");
        ...
        html_body.push_str("<div");
        html_body
            .push_str(" style=\"padding-top: 1rem; border-top: 1px solid var(--border-color);\"");
        html_body.push_str(">");
        html_body.push_str("<form");
        ...
        html_body.push_str("<p");
        html_body
            .push_str(" style=\"margin: 0.25rem 0 0; color: var(--text-dim); font-size: 0.9rem;\"");
        html_body.push_str(">");
        ...
        html_body.push_str(" class=\"stat-val\"");
        html_body.push_str(">");
        html_body.push_str(&(model.subscribers.len()).to_string());
        html_body.push_str("</span>");
        html_body.push_str("<span");
        html_body.push_str(" class=\"stat-label\"");
        html_body.push_str(">");
        ...
        html_body.push_str("<div");
        html_body.push_str(
            " style=\"margin-top: 1rem; font-size: 0.8rem; color: var(--accent-success);\"",
        );
        html_body.push_str(">");
        html_body.push_str("<span");
        ...
        html_body.push_str(" class=\"stat-val\"");
        html_body.push_str(">");
        html_body.push_str(&(model.templates.len()).to_string());
        html_body.push_str("</span>");
        html_body.push_str("<span");
        html_body.push_str(" class=\"stat-label\"");
        html_body.push_str(">");
        ...
        html_body.push_str("<div");
        html_body
            .push_str(" style=\"margin-top: 1rem; font-size: 0.8rem; color: var(--text-dim);\"");
        html_body.push_str(">");
        html_body.push_str("Click to manage →");
        html_body.push_str("</div>");
        html_body.push_str("</div>");
        html_body.push_str("<div");
        html_body.push_str(" class=\"glass-panel stat-card\"");
        ...
        html_body.push_str("<div");
        html_body
            .push_str(" style=\"display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;\"");
        html_body.push_str(">");
        ...
        html_body.push_str(" class=\"btn btn-secondary\"");
        html_body.push_str(
            " onclick=\"switchTab('templates'); setTimeout(() => resetTemplateForm(), 100);\"",
        );
        ...
        html_body.push_str(" class=\"btn btn-secondary\"");
        html_body.push_str(
            " style=\"justify-content: flex-start; width: 100%; text-decoration: none;\"",
        );
        html_body.push_str(">");
        html_body.push_str("<svg");
        html_body.push_str(" width=\"16\"");
        ...
        html_body.push_str(" class=\"glass-panel\"");
        html_body
            .push_str(" style=\"padding: 1rem; display: flex; align-items: center; gap: 1rem;\"");
        html_body.push_str(">");
        html_body.push_str("<div");
        ...
        if model.subscribers.is_empty() {
            ...
            html_body.push_str("<h3");
            html_body
                .push_str(" style=\"margin: 0 0 0.5rem; font-size: 1.25rem; font-weight: 600;\"");
            html_body.push_str(">");
        ...
        if !model.subscribers.is_empty() {
            ...
            for sub in &model.subscribers {
                ...
                html_body.push_str(">");
                html_body.push_str(&(sub.email.chars().next().unwrap_or('?')).to_string());
                html_body.push_str("</div>");
                html_body.push_str("</td>");
                html_body.push_str("<td");
                html_body.push_str(">");
        ...
        for tmpl in &model.templates {
            ...
            html_body.push_str(&format!(
                ...
                tmpl.name,
                tmpl.subject,
                nucleus_std::utils::url_encode(&tmpl.body)
            ));
            html_body.push_str(">");
            html_body.push_str("<div");
            html_body.push_str(
            ...
            html_body.push_str(">");
            html_body.push_str(&(tmpl.name).to_string());
            html_body.push_str("</div>");
            html_body.push_str("<form");
            html_body.push_str(" method=\"POST\"");
        ...
        html_body.push_str(
            " style=\"font-size:0.75rem; justify-content:flex-start; padding:0.5rem 0.75rem;\"",
        );
        html_body.push_str(">");
        html_body.push_str("🎉 Welcome Email");
        html_body.push_str("</button>");
        html_body.push_str("<button");
        html_body.push_str(" class=\"btn btn-secondary\"");
        ...
        html_body.push_str(">");
        html_body.push_str("🏷\u{fe0f} Promotional");
        html_body.push_str("</button>");
        html_body.push_str("</div>");
        html_body.push_str("</div>");
        html_body.push_str("</div>");
        ...
        html_body
            .push_str(" style=\"font-size:0.8rem; color:var(--text-muted); margin-right:0.5rem;\"");
        html_body.push_str(">");
        html_body.push_str("</span>");
        html_body.push_str("<button");
        html_body.push_str(" class=\"btn btn-primary\"");
        ...
        if !model.templates.is_empty() {
            ...
            for tmpl in &model.templates {
                ...
                html_body.push_str(&format!(
                    " onclick=\"selectBroadcastTemplate({}, '{}', '{}')\"",
                    tmpl.id, tmpl.name, tmpl.subject
                ));
                html_body.push_str(">");
                html_body.push_str("<input");
                ...
                html_body.push_str(&(tmpl.subject).to_string());
                html_body.push_str("</div>");
                html_body.push_str("</div>");
                html_body.push_str("<svg");
                html_body.push_str(" width=\"20\"");
        ...
        html_body.push_str("<h3");
        html_body.push_str(
            " style=\"margin: 0; font-size: 1.1rem; font-weight: 600; color: var(--text-muted);\"",
        );
        html_body.push_str(">");
        ...
        html_body.push_str("<div");
        html_body
            .push_str(" style=\"font-size: 0.85rem; color: var(--text-muted); line-height: 1.6;\"");
        html_body.push_str(">");
        html_body.push_str("<div");
    ...
    html_body.push_str("<button");
    html_body
        .push_str(" onclick=\"document.getElementById('preview-modal').style.display='none'\"");
    html_body
        .push_str(" style=\"background:none; border:none; cursor:pointer; font-size: 1.2rem;\"");
    html_body.push_str(">");
...
async fn handle_action_admin(
    ...
    if action == "login" {
        ...
        let valid_user =
            !config.app.admin_username.is_empty() && username == config.app.admin_username;
        ...
        if valid_user && valid_pass {
            ...
            return ([(SET_COOKIE, cookie_val)], Redirect::to("/admin")).into_response();
        } else {
    ...
    if !is_authenticated {
        ...
        let err_html = if !error.is_empty() {
            format!(
                "<div style='color: #ef4444; margin-bottom: 1rem; text-align: center;'>{}</div>",
                error
            )
        } else {
            String::new()
                    ...
                    if let Ok(tmpl_id) = id_str.parse::<i64>() {
                        match newsletter::broadcast_template(tmpl_id).await {
                            Ok(msg) => {
                                ...
                                return Redirect::to(&format!("/admin?msg={}", encoded))
                                    .into_response();
                            }
                            Err(e) => {
                                let encoded = nucleus_std::utils::url_encode(&e);
                                return Redirect::to(&format!("/admin?error={}", encoded))
                                    .into_response();
                            }
                        }
                    }
...
async fn handle_components(
    ...
    html_body.push_str(">");
    html_body.push_str("<a href=\"/\" data-nucleus-link=\"true\">");
    html_body.push_str("🧩 Components Showcase");
    html_body.push_str("</a>");
    html_body.push_str("<div");
    ...
    html_body.push_str(">");
    html_body
        .push_str("&lt;Badge variant=\"primary\" icon=\"⚡\"&gt;New Feature&lt;/Badge&gt;\n    ");
    html_body.push_str("</div>");
    html_body.push_str("</section>");
    ...
    html_body.push_str("<p");
    html_body.push_str(">");
    html_body.push_str("Nucleus Component System — Props, Slots, Scoped CSS");
    html_body.push_str("</p>");
    html_body.push_str("</footer>");
    html_body.push_str("</n:layout>");
    html_body.push_str("<!-- Nucleus Client-Side Router for SPA-like navigation -->");
...
async fn handle_playground(
    ...
    html_body.push_str(">");
    html_body.push_str("🚀 Landing Page");
    html_body.push_str("</button>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"template-group\"");
    ...
    html_body.push_str(">");
    html_body.push_str("🔘 Button System");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"template-item\"");
    html_body.push_str(" data-template=\"form\"");
    html_body.push_str(">");
    html_body.push_str("📝 Forms & Inputs");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"template-item\"");
    html_body.push_str(" data-template=\"wizard\"");
    html_body.push_str(">");
    html_body.push_str("📋 Multi-Step Form");
    html_body.push_str("</button>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"template-group\"");
    ...
    html_body.push_str(">");
    html_body.push_str("⚡ Client (Simple)");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"template-item\"");
    html_body.push_str(" data-template=\"state_form\"");
    html_body.push_str(">");
    html_body.push_str("📝 Form (Server)");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"template-item\"");
    html_body.push_str(" data-template=\"state_island\"");
    html_body.push_str(">");
    html_body.push_str("⚛\u{fe0f} Neutron (Complex)");
    html_body.push_str("</button>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"template-group\"");
    ...
    html_body.push_str(">");
    html_body.push_str("📦 Imports");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"template-item\"");
    html_body.push_str(" data-template=\"data\"");
    html_body.push_str(">");
    html_body.push_str("📊 Data Binding");
    html_body.push_str("</button>");
    html_body.push_str("<button");
    html_body.push_str(" class=\"template-item\"");
    ...
    html_body.push_str(">");
    html_body.push_str("📰 Blog Layout");
    html_body.push_str("</button>");
    html_body.push_str("</div>");
    html_body.push_str("</div>");
    html_body.push_str("</div>");
    ...
    html_body.push_str(">");
    html_body.push_str("Click ★ on a project to add it here");
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body
        .push_str(" style=\"width: 100%; height: 100%; position: absolute; top: 0; left: 0;\"");
    html_body.push_str(">");
    html_body.push_str("</div>");
    html_body.push_str("<textarea");
    ...
    html_body.push_str(">");
    html_body
        .push_str("You have a saved version of this template. Which one would you like to load?");
    html_body.push_str("</p>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    ...
    html_body.push_str("<script");
    html_body
        .push_str(" src=\"https://cdn.jsdelivr.net/npm/monaco-editor@0.45.0/min/vs/loader.js\"");
    html_body.push_str(">");
    html_body.push_str("");
    html_body.push_str("</script>");
    html_body.push_str("<script");
...
async fn handle_docs(
    ...
    html_body.push_str(">");
    html_body.push_str("Explore Guides →");
    html_body.push_str("</a>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"docs-card\"");
    ...
    html_body.push_str(">");
    html_body.push_str("View Reference →");
    html_body.push_str("</a>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
    html_body.push_str(" class=\"docs-card\"");
    ...
    html_body.push_str(">");
    html_body.push_str("Learn Tooling →");
    html_body.push_str("</a>");
    html_body.push_str("</div>");
    html_body.push_str("</div>");
    html_body.push_str("<div");
...
pub async fn app() -> Router {
    ...
    #[allow(clippy::let_and_return)]
    {
        let app = Router::new()
            ...
            .route("/admin", get(handle_admin).post(handle_action_admin))
            .route("/clean_layout", get(handle_clean_layout))
            ...
            .route_service(
                "/docs/manifest.json",
                tower_http::services::ServeFile::new("static/docs/manifest.json"),
            )
            .layer(
