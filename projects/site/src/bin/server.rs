...
async fn handle_index() -> impl IntoResponse {
    Html("No view found in src/views/index.ncl")
}
#[allow(non_snake_case)]
async fn handle_components() -> impl IntoResponse {
    Html("No view found in src/views/components.ncl")
}
#[allow(non_snake_case)]
async fn handle_docs() -> impl IntoResponse {
    Html("No view found in src/views/docs.ncl")
}
...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/components", get(handle_components))
