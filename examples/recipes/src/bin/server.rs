...
async fn handle_counter(headers: axum::http::HeaderMap, Query(params): Query<std::collections::HashMap<String, String>>) -> impl axum::response::IntoResponse {
...
#[allow(non_snake_case, unreachable_code, unused_variables)]
async fn handle_todo(headers: axum::http::HeaderMap, Query(params): Query<std::collections::HashMap<String, String>>) -> impl axum::response::IntoResponse {
...
html_body.push_str(" style=\"padding: 0.5rem 1rem; background: #4facfe; border: none; color: white;\"");
html_body.push('>');
...
html_body.push_str(" style=\"background: #222; padding: 1rem; margin-bottom: 0.5rem; border-radius: 4px;\"");
html_body.push('>');
html_body.push_str("<span");
...
#[allow(non_snake_case, unreachable_code, unused_variables)]
async fn handle_login(headers: axum::http::HeaderMap, Query(params): Query<std::collections::HashMap<String, String>>) -> impl axum::response::IntoResponse {
...
#[allow(non_snake_case, unreachable_code, unused_variables)]
async fn handle_island_test(headers: axum::http::HeaderMap, Query(params): Query<std::collections::HashMap<String, String>>) -> impl axum::response::IntoResponse {
...
html_body.push_str("</p>");
html_body.push_str("<div");
html_body.push_str(" style=\"height: 150vh; background: #222; margin: 2rem 0; padding: 1rem; color: #666;\"");
html_body.push('>');
...
async fn handle_counter_widget() -> impl IntoResponse { Html("No view found in src/views/components/counter_widget.ncl") }#[allow(non_snake_case, unreachable_code, unused_variables)]
async fn handle_ts_test(headers: axum::http::HeaderMap, Query(params): Query<std::collections::HashMap<String, String>>) -> impl axum::response::IntoResponse {
...
#[allow(non_snake_case, unreachable_code, unused_variables)]
async fn handle_action_success(headers: axum::http::HeaderMap, Query(params): Query<std::collections::HashMap<String, String>>) -> impl axum::response::IntoResponse {
...
#[allow(non_snake_case, unreachable_code, unused_variables)]
async fn handle_action_test(headers: axum::http::HeaderMap, Query(params): Query<std::collections::HashMap<String, String>>) -> impl axum::response::IntoResponse {
...
#[allow(non_snake_case, unreachable_code, unused_variables)]
async fn handle_action_action_test(headers: axum::http::HeaderMap, Form(params): Form<std::collections::HashMap<String, String>>) -> impl axum::response::IntoResponse {
...
#[allow(non_snake_case, unreachable_code, unused_variables)]
async fn handle_hello(headers: axum::http::HeaderMap, Query(params): Query<std::collections::HashMap<String, String>>) -> impl axum::response::IntoResponse {
...
html_body.push_str("</body></html>");
    ...
    axum::response::Html(html_body).into_response()
        ...
        async fn main() {
            ...
            let app = Router::new()
                .route("/counter", get(handle_counter)).route("/todo", get(handle_todo)).route("/login", get(handle_login)).route("/", get(handle_index)).route("/island_test", get(handle_island_test)).route("/counter_widget", get(handle_counter_widget)).route("/ts_test", get(handle_ts_test)).route("/action_success", get(handle_action_success)).route("/action_test", get(handle_action_test).post(handle_action_action_test)).route("/hello", get(handle_hello))
