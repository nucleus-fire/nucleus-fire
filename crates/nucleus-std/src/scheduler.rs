...
impl Scheduler {
        ...
        Fut: Future<Output = ()> + Send + 'static,
    {
        ...
        tasks.insert(
            name.to_string(),
            ScheduledTask::new_recurring(name, schedule, boxed_task),
        );
        ...
        Fut: Future<Output = ()> + Send + 'static,
    {
        ...
        tasks.insert(
            name.to_string(),
            ScheduledTask::new_once(name, at, boxed_task),
        );
